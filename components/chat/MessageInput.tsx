...
export function MessageInput({
  ...
  return (
    <div className="sticky bottom-0 border-t border-slate-800/60 bg-slate-950/90 backdrop-blur-md relative pb-[env(safe-area-inset-bottom)]">
      {replyTo && (
        <div className="flex items-center gap-2 px-3 sm:px-4 py-2 border-b border-slate-800/40">
      ...
      {uploading && (
        <div className="px-3 sm:px-4 py-2 bg-violet-600/10 border-b border-violet-500/20">
      ...
      <div className="flex items-center gap-2 p-2.5 sm:p-3">
        <button
          ...
          disabled={uploading}
          className="w-10 h-10 sm:w-9 sm:h-9 flex-shrink-0 self-end sm:self-auto flex items-center justify-center rounded-2xl sm:rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-700/50 text-slate-400 hover:text-white transition disabled:opacity-50"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
        ...
        <button
          ...
          className="w-10 h-10 sm:w-9 sm:h-9 flex-shrink-0 self-end sm:self-auto flex items-center justify-center rounded-2xl sm:rounded-xl bg-gradient-to-br from-violet-600 to-purple-600 hover:from-violet-500 hover:to-purple-500 text-white disabled:opacity-40 disabled:cursor-not-allowed transition shadow-md shadow-violet-900/30"
        >
