...
export function MembersSidebar({ members, room, userName, isOpen, onClose }: Props) {
  const sidebar = (
    <div className="w-64 h-full flex flex-col bg-slate-950/95 border-l border-slate-800/60">
      ...
      <div className="flex-1 overflow-y-auto py-2">
        {members.map((member) => (
          <div
            key={member.socketId}
            className="flex items-center gap-3 px-4 py-2 hover:bg-slate-800/40 transition rounded-lg mx-1"
          >
